...
if( isset( $_FILES['logo'] ) )
{
  ...
  set_message( 'Project logo has been updated' );
...
if( isset( $_GET['id'] ) )
{
  ...
  if( isset( $_GET['delete'] ) )
  {
    ...
    set_message( 'Project logo has been deleted' );
...
<p>
  Note: For best results, logos should be approximately 800 x 800 pixels.
</p>
...
<?php if( $record['logo'] ): ?>
  ...
  <p><a href="skills_logo.php?id=<?php echo $_GET['id']; ?>&delete"><i class="fas fa-trash-alt"></i> Delete this logo</a></p>
